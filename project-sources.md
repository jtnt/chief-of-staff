...
- **Key files:** `CLAUDE.md`, `Claude.ai Chats/index.md`, `Sales Intelligence Platform/CRO-Recommendation-Summary-v2.md`, `Sales Intelligence Platform/Validation-Notes-v2.md`
